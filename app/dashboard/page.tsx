      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          ...
          <nav className="hidden items-center gap-8 text-sm text-slate-300 md:flex">
            <a className="hover:text-yellow-400" href="#markets">
              Markets
            </a>
            <a className="hover:text-yellow-400" href="#deals">
              Deals
            </a>
            <a className="hover:text-yellow-400" href="#insights">
              Insights
            </a>
            <a className="hover:text-yellow-400" href="#pricing">
              Pricing
            </a>
            <a
              href="/dashboard"
              className="rounded-full bg-yellow-400 px-5 py-2 font-semibold text-slate-950 hover:bg-yellow-300"
            >
              Get Started
            </a>
          </nav>
      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div>
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            <a
              href="/dashboard"
              className="rounded-xl bg-yellow-400 px-8 py-4 text-center font-bold text-slate-950 hover:bg-yellow-300"
            >
              Explore Markets
            </a>
            <a
              href="/dashboard"
              className="rounded-xl border border-white/15 px-8 py-4 text-center font-bold text-white hover:border-yellow-400"
            >
              View Top Deals
            </a>
          </div>
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 shadow-2xl">
          <div className="rounded-2xl bg-slate-900 p-6">
            ...
            <a
              href="/dashboard"
              className="mt-6 block rounded-xl border border-yellow-400/40 px-5 py-3 text-center font-semibold text-yellow-300 hover:bg-yellow-400 hover:text-slate-950"
            >
      ...
      <section id="markets" className="border-y border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-7xl px-6 py-20">
          ...
          <p className="mt-4 max-w-3xl text-slate-300">
            Start with Santiago and Santo Domingo, then expand into the full
            Dominican Republic with city-level benchmarks and deal discovery.
          </p>
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {markets.map((market) => (
              <a
                href="/dashboard"
                key={market.city}
                className="rounded-3xl border border-white/10 bg-slate-900 p-6 transition hover:border-yellow-400/60 hover:bg-slate-800"
              >
      ...
      <section id="deals" className="mx-auto max-w-7xl px-6 py-20">
        <div className="mb-10 flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-bold">
              Deal intelligence at a glance.
            </h2>
            <p className="mt-4 max-w-2xl text-slate-300">
              Preview how PropVero will rank opportunities by score, yield, and
              market context.
            </p>
          </div>
          <a
            href="/dashboard"
            className="rounded-xl border border-yellow-400/40 px-6 py-3 text-center font-semibold text-yellow-300 hover:bg-yellow-400 hover:text-slate-950"
          >
            Preview Pro
          </a>
        </div>
        ...
        <div className="overflow-hidden rounded-3xl border border-white/10 bg-slate-900">
          ...
          {opportunities.map((item) => (
            <a
              href="/dashboard"
              key={`${item.city}-${item.property}`}
              className="grid grid-cols-4 border-t border-white/10 px-6 py-5 text-sm hover:bg-white/[0.03]"
            >
      ...
      <section id="pricing" className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="mx-auto mt-10 grid max-w-4xl gap-6 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-slate-900 p-8">
            ...
            <a
              href="/dashboard"
              className="mt-8 block rounded-xl border border-white/15 px-6 py-3 text-center font-semibold hover:border-yellow-400"
            >
              Start Free
            </a>
          </div>
          ...
          <div className="rounded-3xl border border-yellow-400/40 bg-yellow-400/10 p-8">
            ...
            <a
              href="/dashboard"
              className="mt-8 block rounded-xl bg-yellow-400 px-6 py-3 text-center font-bold text-slate-950 hover:bg-yellow-300"
            >
              Join Pro
            </a>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20">
        <div className="rounded-3xl border border-white/10 bg-gradient-to-r from-yellow-400/20 to-white/[0.03] p-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-slate-300">
            PropVero is building the intelligence layer for Dominican Republic real
            estate.
          </p>
      ...
      <footer className="border-t border-white/10 px-6 py-10">
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-6 md:flex-row">
          ...
          <div className="flex flex-wrap gap-6 text-sm text-slate-400">
            ...
            <a className="hover:text-yellow-400" href="/dashboard">
              Dashboard
            </a>
          </div>
        </div>
